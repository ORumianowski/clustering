...
# ⚠️ Supprimer les lignes avec NA
X <- na.omit(X)
...
init.mu1 <- d_means + rnorm(d, 0, 1)
init.mu2 <- d_means + rnorm(d, 0, 1)
init.mu3 <- d_means + rnorm(d, 0, 1)
...
make_aplats <- function(mu_list, Sigma_list,
                        ...
                        alphas = seq(0.15, 0.15, length.out = 10),
                        fill_cols) {
...
# Palette de couleurs des clusters
cluster_cols <- c("darkorange", "purple", "seagreen")

# Reconstruire les aplats avec la nouvelle palette
...
# ==========================================================
# Plot final : titres simplifiés et légende sans titre
# ==========================================================
# ==========================================================
# Plot final : titres simplifiés et légende sans titre
# ==========================================================
