...
cat("➡️ Chaîne 1...\n")
samples1 <- runMCMC(cmcmc, niter = 2000, nburnin = 2, thin = 2,
                    inits = inits1, setSeed = 100)

cat("➡️ Chaîne 2...\n")
samples2 <- runMCMC(cmcmc, niter = 2000, nburnin = 2, thin = 2,
...
cat("➡️ Chaîne 1 (naïf)...\n")
samples_naif1 <- runMCMC(cmcmc_naif, niter = 2000, nburnin = 2, thin = 2,
                         inits = inits1, setSeed = 101)

cat("➡️ Chaîne 2 (naïf)...\n")
samples_naif2 <- runMCMC(cmcmc_naif, niter = 2000, nburnin = 2, thin = 2,
