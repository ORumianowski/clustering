...
# ==================================================
# 5) Données pour NIMBLE + Grille LxL appariée
# ==================================================
D <- 4L
...
## >>> Grille régulière LxL pour l'intégration (remplace l'ancien tirage) <<<
L <- 100L  # résolution (100 => M = 10 000)
...
# Ω évalué aux mêmes centres (appariement 1–à–1)
...
# Grilles passées aux deux saisons (mêmes points)
grid_su <- grid_mat
grid_wi <- grid_mat
